...
public class Calendrier extends Application {
    ...
    private TableView<Journee> planningTable;
    ...
    public void start(Stage primaryStage) {
      ...
      /*   private void updateCalendar() {
            ...
            calendarGrid.add(planningTable, 0, row, 7, 1);
